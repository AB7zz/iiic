...
const About = () => {
  return (
    <div className='grid grid-cols-2 py-32'>
      <div className='pl-20'>
        <div className='rounded bg-white bg-opacity-100 px-4 py-5 absolute rounded-[12px] left-[385px] top-[1200px]'>
          <div>
      ...
      <div className='pl-16'>
        <h2 className='font-bold text-4xl text-[#0A043C]'>Engineering Talent Hub:</h2>
        <h2 className='font-bold text-4xl text-[#0A043C]'>School of Engineering, CUSAT</h2>
